...
struct WeatherConditionIcons {
    ...
    var icon: UIImage? {
        ...
        case "partly-cloudy-and-light-rain", "partly-cloudy-and-rain", "partly-cloudy-and-snow":
            return UIImage.rainAndSunIcon
        case "overcast":
            return UIImage.cloudsIcon
        case "overcast-and-rain", "cloudy-and-light-rain", "overcast-and-light-rain", "cloudy-and-rain", "overcast-and-wet-snow", "partly-cloudy-and-light-snow", "overcast-and-snow", "cloudy-and-light-snow", "overcast-and-light-snow", "cloudy-and-snow":
